...
families, 85 verbs, every flag checked against the binary this repository
builds.
...
All 85 verbs, grouped as the README groups them. **Reads** is what a
