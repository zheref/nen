...
- **docs** — README gains a "Day to day" section: pin the binary once, set up a repository's taxonomy, and the six verbs a maintainer runs most, each runnable as printed ([#PR](link))
