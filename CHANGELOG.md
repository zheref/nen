...
- `nen repo scenario` and `nen canon resolve` now require `--repo`, matching what their own usage lines already promised. ([#73](https://github.com/zheref/nen/pull/73))
...
- **parse / watch** — stop a lone leading slot from swallowing a template's `[ ... ]` clause ([#67](https://github.com/zheref/nen/pull/67), closes #30)
...
- **ref** — split the no-`#` shorthand at the longest trailing digit run ([#72](https://github.com/zheref/nen/pull/72), closes #26)
